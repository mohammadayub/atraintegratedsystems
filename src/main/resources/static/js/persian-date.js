...
module.exports = {
    ...
    persian: {
        months: ['Hamal', 'Sawr', 'Jawza', 'Saratan', 'Asad', 'Sunbala', 'Meezan', 'Aqrab', 'Qaws', 'Jaddi', 'Dalwa', 'Hoot'],
...
module.exports = {
    ...
    persian: {
        months: ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'اسد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
