...
@Controller
public class SMSIdentifierController {
     ...
     */
    @GetMapping("/codes/standard/smsidentifier")
     ...
     */
    @GetMapping("/codes/standard/smsidentifier/add")
     ...
     */
    @PostMapping("/codes/standard/smsidentifier/add")
